...
# Второй, с декоратором @staticmethod, должен проводить валидацию числа, месяца и года (например, месяц — от 1 до 12). Проверить работу полученной
...
#
#
# today = Data('23 - 3 - 2022')
# print(today)
# print(Data.extraction('10 - 03 - 2001'))
# print(today.extraction('11 - 11 - 2020'))
# print(Data.valid(11, 11, 2022))
# print(today.valid(11, 15, 2001))
...
# #
# div = ZeroDevisionError(10, 100)
# print(ZeroDevisionError.divide_by_null(10, 0))
# print(ZeroDevisionError.divide_by_null(100, 0.1))
...
# на реальном примере. Необходимо запрашивать у пользователя данные и заполнять список только числами. Класс-исключение должен контролировать
...
# классов-наследников. Эти классы — конкретные типы оргтехники (принтер, сканер, ксерокс). В базовом классе определить параметры, общие для приведенных
...
#
#
# unit_1 = Printer('Asus', 50000, 5, 10)
# unit_2 = Scanner('Canon', 6200, 5, 10)
